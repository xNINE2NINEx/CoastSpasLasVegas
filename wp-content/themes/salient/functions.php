...
if ( !function_exists( 'nectar_page_header' ) ) {
    ...
    ?>
	    ...
	    <div class="not-loaded" id="page-header-bg" data-parallax="<?php echo (!empty($parallax_bg) && $parallax_bg == 'on') ? '1' : '0'; ?>" data-height="<?php echo (!empty($height)) ? $height : '500'; ?>" style="background-image: url(<?php echo $bg; ?>); height: <?php echo $height;?>px;">
			<div class="container">	
				<div class="row">
